...
export class Example20 {
  title = 'Example 20: Row Detail View';
  subTitle = `
  ...
  defineGrid() {
    ...
    this.gridOptions = {
      ...
      rowDetailView: {
        ...
        preloadView: PLATFORM.moduleName('examples/slickgrid/example20-preload.html'),

        // ViewModel Template to load when row detail data is ready
        viewModel: PLATFORM.moduleName('examples/slickgrid/example20-detail-view'),
      }
    };
  }

describe('Example 45 - Row Detail with inner Grid', () => {
  ...
  it('should change Row Detail panel height to 15, open 2nd and 3rd then execute PageDown twice', () => {
    ...
    // open 3rd row detail
    cy.get(`.slick-row[data-row="${ROW_DETAIL_PANEL_COUNT - 1}"] .slick-cell:nth(0)`).click().wait(40);
  ...
  it('should clear Company ID filter and have all rows back in grid and rendered', () => {
    ...
    cy.get('#grid45 .slick-row:not(#innergrid-1 .slick-row,#innergrid-2 .slick-row)').should('have.length.greaterThan', ROW_DETAIL_PANEL_COUNT * 2);

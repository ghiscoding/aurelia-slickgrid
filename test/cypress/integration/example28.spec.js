...
describe('Example 28 - Tree Data (from a Hierarchical Dataset)', { retries: 2 }, () => {
  ...
  it('should display Example title', () => {
    cy.visit(`${Cypress.config('baseExampleUrl')}/example28`);
    cy.get('h2').should('contain', 'Example 28: Tree Data (from a Hierarchical Dataset)');
  });

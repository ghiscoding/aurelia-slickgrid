  ...
  register(): any {
    if (this.sharedService && this.sharedService.grid && this.sharedService.gridOptions) {
      ...
      if (this.sharedService.grid && this._addonOptions) {
        ...
        this._eventHandler.subscribe(onCopyCellsHandler, (e: any, args: { ranges: SelectedRange[] }) => {
        ...
        this._eventHandler.subscribe(onCopyCancelledHandler, (e: any, args: { ranges: SelectedRange[] }) => {
        ...
        this._eventHandler.subscribe(onPasteCellsHandler, (e: any, args: { ranges: SelectedRange[] }) => {

...
export class GridMenuExtension implements Extension {
  ...
  register(): any {
    ...
    if (this.sharedService.gridOptions && this.sharedService.gridOptions.gridMenu) {
      ...
      // hook all events
      if (this.sharedService.grid && this._gridMenuOptions) {
  ...
  translateGridMenu() {
    ...
    if (this.sharedService.gridOptions && this._gridMenuOptions) {
      ...
      this._gridMenuOptions.columnTitle = this.extensionUtility.getPickerTitleOutputString('columnTitle', 'gridMenu');
      this._gridMenuOptions.forceFitTitle = this.extensionUtility.getPickerTitleOutputString('forceFitTitle', 'gridMenu');
      this._gridMenuOptions.syncResizeTitle = this.extensionUtility.getPickerTitleOutputString('syncResizeTitle', 'gridMenu');
      ...
      if (this._addon && this._addon.updateAllTitles) {
        this._addon.updateAllTitles(this._gridMenuOptions);
      }
    }
  }
  ...
  private addGridMenuCustomCommands(originalCustomItems: Array<GridMenuItem | 'divider'>) {
          ...
          gridMenuCustomItems.push(
            {
              ...
              title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}CLEAR_ALL_FILTERS`) : this._locales && this._locales.TEXT_CLEAR_ALL_FILTERS,
              disabled: false,
              command: commandName,
              positionOrder: 50
            }
          ...
          gridMenuCustomItems.push(
            {
              ...
              title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}TOGGLE_FILTER_ROW`) : this._locales && this._locales.TEXT_TOGGLE_FILTER_ROW,
              disabled: false,
              command: commandName,
              positionOrder: 52
            }
          ...
          gridMenuCustomItems.push(
            {
              ...
              title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}REFRESH_DATASET`) : this._locales && this._locales.TEXT_REFRESH_DATASET,
              disabled: false,
              command: commandName,
              positionOrder: 56
            }
          ...
          gridMenuCustomItems.push(
            {
              ...
              title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}TOGGLE_PRE_HEADER_ROW`) : this._locales && this._locales.TEXT_TOGGLE_PRE_HEADER_ROW,
              disabled: false,
              command: commandName,
              positionOrder: 52
            }
          ...
          gridMenuCustomItems.push(
            {
              ...
              title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}CLEAR_ALL_SORTING`) : this._locales && this._locales.TEXT_CLEAR_ALL_SORTING,
              disabled: false,
              command: commandName,
              positionOrder: 51
            }
        ...
        gridMenuCustomItems.push(
          {
            ...
            title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}EXPORT_TO_CSV`) : this._locales && this._locales.TEXT_EXPORT_TO_CSV,
            disabled: false,
            command: commandName,
            positionOrder: 53
          }
        ...
        gridMenuCustomItems.push(
          {
            ...
            title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}EXPORT_TO_EXCEL`) : this._locales && this._locales.TEXT_EXPORT_TO_EXCEL,
            disabled: false,
            command: commandName,
            positionOrder: 54
          }
        ...
        gridMenuCustomItems.push(
          {
            ...
            title: this.sharedService.gridOptions.enableTranslate ? this.i18n.tr(`${translationPrefix}EXPORT_TO_TAB_DELIMITED`) : this._locales && this._locales.TEXT_EXPORT_TO_TAB_DELIMITED,
            disabled: false,
            command: commandName,
            positionOrder: 55
          }
    ...
    if (this.sharedService.gridOptions && this._gridMenuOptions && (gridMenuCustomItems.length > 0 || (this._gridMenuOptions.customItems && this._gridMenuOptions.customItems.length > 0))) {

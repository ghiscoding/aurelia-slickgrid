  ...
  sortCollection(columnDef: Column, collection: any[], sortByOptions: CollectionSortBy | CollectionSortBy[], enableTranslateLabel?: boolean): any[] {
    ...
    if (sortByOptions) {
      if (Array.isArray(sortByOptions)) {
        ...
        sortedCollection = collection.sort((dataRow1: any, dataRow2: any) => {
          for (let i = 0, l = sortByOptions.length; i < l; i++) {
            ...
            if (sortBy && sortBy.property) {
              ...
              const value1 = (enableTranslateLabel) ? this.i18n && this.i18n.tr && this.i18n.getLocale && this.i18n.getLocale() && this.i18n.tr(dataRow1[objectProperty] || ' ') : dataRow1[objectProperty];
              const value2 = (enableTranslateLabel) ? this.i18n && this.i18n.tr && this.i18n.getLocale && this.i18n.getLocale() && this.i18n.tr(dataRow2[objectProperty] || ' ') : dataRow2[objectProperty];
        ...
        sortedCollection = collection.sort((dataRow1: any, dataRow2: any) => {
          const value1 = (enableTranslateLabel) ? this.i18n && this.i18n.tr && this.i18n.getLocale && this.i18n.getLocale() && this.i18n.tr(dataRow1 || ' ') : dataRow1;
          const value2 = (enableTranslateLabel) ? this.i18n && this.i18n.tr && this.i18n.getLocale && this.i18n.getLocale() && this.i18n.tr(dataRow2 || ' ') : dataRow2;
          const sortResult = sortByFieldType(fieldType, value1, value2, sortDirection, columnDef);
          if (sortResult !== SortDirectionNumber.neutral) {
            return sortResult;
          }

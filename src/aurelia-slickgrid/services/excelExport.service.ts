...
export class ExcelExportService {
  ...
  useCellFormatByFieldType(data: string | Date | moment.Moment, fieldType: FieldType): ExcelCellFormat | string {
    let outputData: ExcelCellFormat | string | Date | moment.Moment = data;
    switch (fieldType) {

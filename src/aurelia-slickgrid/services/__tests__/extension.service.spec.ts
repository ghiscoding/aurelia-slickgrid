...
describe('ExtensionService', () => {
  ...
  describe('without I18N Service', () => {
    ...
    it('should throw an error if "enableTranslate" is set but the I18N Service is null and "translateColumnHeaders" method is called', () => {
      expect(() => service.translateColumnHeaders())
        .toThrowError('[Aurelia-Slickgrid] requires "I18N" to be installed and configured');
    });
    ...
    it('should throw an error if "enableTranslate" is set but the I18N Service is null and "translateItems" private method is called', (done) => {
      try {
        ...
        expect(e.message).toContain('[Aurelia-Slickgrid] requires "I18N" to be installed and configured');
        done();
      }
    });
  });

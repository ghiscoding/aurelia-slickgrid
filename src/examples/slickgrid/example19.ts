...
export class Example19 {
  ...
  subTitle = `
    Add functionality to show extra information with a Row Detail View, (<a href="https://github.com/slickclub/aurelia-slickgrid/wiki/Row-Detail" target="_blank">Wiki docs</a>)
    <ul>

...
export class Example17 {
  ...
  subTitle = `
    ...
    <ul>
      ...
      <li>
        Soure code for this example is available <a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/blob/master/doc/github-demo/src/examples/slickgrid/example17.ts" target="_blank">here</a>
      </li>
    </ul>
  `;

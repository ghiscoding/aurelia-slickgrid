...
export class Example4 {
  ...
  subTitle = `
  Sort/Filter on client side only using SlickGrid DataView (<a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Sorting" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">
    ...
    <li>Custom Filter are now possible, "Description" column below, is a customized InputFilter with different placeholder. See <a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Custom-Filter" target="_blank">Wiki - Custom Filter</a></li>
  </ul>
`;

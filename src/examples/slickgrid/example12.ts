...
export class Example12 {
  ...
  subTitle = `Support multiple locales with the i18next plugin, following these steps.
    Take a look at the (<a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Localization" target="_blank">Wiki documentation</a>)
    <ol class="small">
      ...
      <li>For the Select (dropdown) filter, you can fill in the "labelKey" property, if found it will use it, else it will use "label"</li>
        <ul>
          ...
          <li>More info on the Select Filter <a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Select-Filter" target="_blank">Wiki page</a>
        </ul>

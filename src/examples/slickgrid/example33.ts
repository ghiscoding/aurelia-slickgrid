...
export class Example33 {
  ...
  subTitle = `
  This demo shows how to create Regular & Custom Tooltips (<a href="https://github.com/slickclub/aurelia-slickgrid/wiki/Custom-Tooltip-(plugin)" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">

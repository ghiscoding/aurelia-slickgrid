    ...
    <ul>
      ...
      <ol>
        <li>Using the <b>Slick.Plugins.CellMenu</b> plugin, often used for an Action Menu(s), 1 or more per grid
          (<a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Cell-Menu" target="_blank">Wiki docs</a>).
        </li>
        <li>Using the <b>Slick.Plugins.ContextMenu</b> plugin, shown after a mouse right+click, only 1 per grid.
        (<a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Context-Menu" target="_blank">Wiki docs</a>).
        </li>
      </ol>

...
export class Example20 {
  ...
  subTitle = `
    This example demonstrates the use of Pinned (aka frozen) Columns and/or Rows (<a href="https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Pinned-(aka-Frozen)-Columns-Rows" target="_blank">Wiki docs</a>)
    <ul>

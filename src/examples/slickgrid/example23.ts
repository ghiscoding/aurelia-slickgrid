...
export class Example23 {
  ...
  subTitle = `
    This demo shows how to use Filters with Range of Search Values (<a href="https://github.com/slickclub/aurelia-slickgrid/wiki/Range-Filters" target="_blank">Wiki docs</a>)
    <br/>
    <ul class="small">

...
### Demo
[Demo Parent/Child Relationship](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example27) / [ViewModel](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/src/examples/slickgrid/example27.ts)

[Hierarchial Dataset](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example28) / [ViewModel](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/src/examples/slickgrid/example28.ts)

...
[Demo Page](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example7) / [Demo Component](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/src/examples/slickgrid/example7.ts)

#### Header Menu Plugin
[Demo Page](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example8) / [Demo Component](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/src/examples/slickgrid/example8.ts)

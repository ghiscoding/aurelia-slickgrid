...
### Demo
[Demo Page](https://ghiscoding.github.io/aurelia-slickgrid/#/localization) / [Demo Component](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/src/examples/slickgrid/example12.ts)

...
### Demo
[Demo](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example24) / [Demo Component](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/src/examples/slickgrid/example24.ts)

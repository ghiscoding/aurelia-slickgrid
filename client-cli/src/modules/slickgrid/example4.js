...
export class List {
  ...
  gridOptions = {};
  gridColumns = {};
  sortASC = '../../../node_modules/slickgrid-es6/images/sort-asc.gif';
  sortDSC = '../../../node_modules/slickgrid-es6/images/sort-desc.gif';
    ...
    for (let i = 0; i < this.gridColumns.length; i++) {
      this.gridColumns[i].header = {
        menu: {
          items: [
            {
              iconImage: this.sortASC,
              title: 'Sort Ascending',
              command: 'sort-asc'
            },
            {
              iconImage: this.sortDSC,

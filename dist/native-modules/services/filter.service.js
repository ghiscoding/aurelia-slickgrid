        ...
        var _loop_1 = function (i) {
            if (this_1._columnDefinitions[i].id !== 'selector' && this_1._columnDefinitions[i].filterable) {
                ...
                if (!columnDef_1.filter) {
                    ...
                    filterTemplate = inputFilterTemplate(searchTerm, columnDef_1);
                }
                else {
                    // custom Select template
                    if (columnDef_1.filter.type === FormElementType.select) {
                        filterTemplate = selectFilterTemplate(searchTerm, columnDef_1);
                    }
                }
                ...
                var filterType = (columnDef_1.filter && columnDef_1.filter.type) ? columnDef_1.filter.type : FormElementType.input;
                switch (filterType) {

...
let GridMenuExtension = class GridMenuExtension {
    ...
    register() {
        ...
        this.userOriginalGridMenu = Object.assign({}, this.sharedService.gridOptions.gridMenu);
...
GridMenuExtension = __decorate([
    singleton(true),
    inject(ExportService, ExtensionUtility, FilterService, I18N, SharedService, SortService)
], GridMenuExtension);

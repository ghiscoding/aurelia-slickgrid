System.register(["aurelia-framework", "aurelia-i18n", "../constants", "./../models/index", "./export.service", "./filter.service", "./sort.service", "./../services/utilities", "jquery"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, aurelia_i18n_1, constants_1, index_1, export_service_1, filter_service_1, sort_service_1, utilities_1, $, ControlAndPluginService;
    return {
        setters: [
            ...
            function (export_service_1_1) {
                export_service_1 = export_service_1_1;
            },
                ...
                ControlAndPluginService.prototype.addGridMenuCustomCommands = function () {
                    ...
                    if (this._gridOptions && this._gridOptions.enableFiltering) {
                        ...
                        if (this._gridOptions && this._gridOptions.gridMenu && !this._gridOptions.gridMenu.hideClearAllFiltersCommand) {
                            gridMenuCustomItems.push({
                                ...
                                title: this._gridOptions.enableTranslate ? this.i18n.tr('CLEAR_ALL_FILTERS') : constants_1.Constants.TEXT_CLEAR_ALL_FILTERS,
                                disabled: false,
                        ...
                        if (this._gridOptions && this._gridOptions.gridMenu && !this._gridOptions.gridMenu.hideToggleFilterCommand) {
                            gridMenuCustomItems.push({
                                ...
                                title: this._gridOptions.enableTranslate ? this.i18n.tr('TOGGLE_FILTER_ROW') : constants_1.Constants.TEXT_TOGGLE_FILTER_ROW,
                                disabled: false,
                        ...
                        if (this._gridOptions && this._gridOptions.gridMenu && !this._gridOptions.gridMenu.hideRefreshDatasetCommand && backendApi) {
                            gridMenuCustomItems.push({
                                ...
                                title: this._gridOptions.enableTranslate ? this.i18n.tr('REFRESH_DATASET') : constants_1.Constants.TEXT_REFRESH_DATASET,
                                disabled: false,
                    ...
                    if (this._gridOptions.enableSorting) {
                        ...
                        if (this._gridOptions && this._gridOptions.gridMenu && !this._gridOptions.gridMenu.hideClearAllSortingCommand) {
                            gridMenuCustomItems.push({
                                ...
                                title: this._gridOptions.enableTranslate ? this.i18n.tr('CLEAR_ALL_SORTING') : constants_1.Constants.TEXT_CLEAR_ALL_SORTING,
                                disabled: false,
                    ...
                    if (this._gridOptions && this._gridOptions.enableExport && this._gridOptions.gridMenu && !this._gridOptions.gridMenu.hideExportCsvCommand) {
                        gridMenuCustomItems.push({
                            ...
                            title: this._gridOptions.enableTranslate ? this.i18n.tr('EXPORT_TO_CSV') : constants_1.Constants.TEXT_EXPORT_IN_CSV_FORMAT,
                            disabled: false,
                            command: 'export-csv',
                            positionOrder: 53
                        });
                    ...
                    if (this._gridOptions && this._gridOptions.enableExport && this._gridOptions.gridMenu && !this._gridOptions.gridMenu.hideExportTextDelimitedCommand) {
                        gridMenuCustomItems.push({
                            ...
                            title: this._gridOptions.enableTranslate ? this.i18n.tr('EXPORT_TO_TAB_DELIMITED') : constants_1.Constants.TEXT_EXPORT_IN_TEXT_FORMAT,
                            disabled: false,

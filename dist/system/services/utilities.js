System.register(["../models/index", "moment", "jquery"], function (exports_1, context_1) {
    ...
    exports_1("htmlEntityDecode", htmlEntityDecode);
    /**
     * decode text into html entity
     * @param string text: input text
     * @param string text: output text
    ...
    exports_1("htmlEntityEncode", htmlEntityEncode);
    /**
    ...
    exports_1("mapOperatorByFieldType", mapOperatorByFieldType);
    /**
    ...
    function getScrollBarWidth() {
        ...
        var widthWithScroll = $('<div>').css({ width: '100%' }).appendTo($outer).outerWidth() || 0;
        $outer.remove();

System.register(["./filter.service", "./graphql.service", "./gridEvent.service", "./grid-odata.service", "./odata.service", "./resizer.service", "./sort.service"], function (exports_1, context_1) {
    "use strict";

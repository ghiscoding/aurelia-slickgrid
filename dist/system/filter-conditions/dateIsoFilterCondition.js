System.register(["../models", "./filterUtilities", "./../services/utilities", "moment"], function (exports_1, context_1) {
    ...
    var models_1, filterUtilities_1, utilities_1, moment, FORMAT, dateIsoFilterCondition;
    return {
        setters: [
            function (models_1_1) {
                models_1 = models_1_1;
        ...
        execute: function () {
            FORMAT = utilities_1.mapMomentDateFormatWithFieldType(models_1.FieldType.dateIso);

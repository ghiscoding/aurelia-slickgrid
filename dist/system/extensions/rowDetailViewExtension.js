System.register(["aurelia-framework", "aurelia-event-aggregator", "../models/index", "./extensionUtility", "../services/shared.service", "../services/utilities", "dompurify", "jquery"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, aurelia_event_aggregator_1, index_1, extensionUtility_1, shared_service_1, utilities_1, DOMPurify, $, ROW_DETAIL_CONTAINER_PREFIX, PRELOAD_CONTAINER_PREFIX, RowDetailViewExtension;
    ...
    return {
        ...
        execute: function () {
            ROW_DETAIL_CONTAINER_PREFIX = 'container_';
            PRELOAD_CONTAINER_PREFIX = 'container_loading';
            RowDetailViewExtension = /** @class */ (function () {
                ...
                RowDetailViewExtension.prototype.dispose = function () {
                    ...
                    utilities_1.disposeAllSubscriptions(this._subscriptions);
                };
                /**
                ...
                RowDetailViewExtension.prototype.create = function (columnDefinitions, gridOptions) {
                    ...
                    if (columnDefinitions && gridOptions) {
                        ...
                        this.extensionUtility.loadExtensionDynamically(index_1.ExtensionName.rowDetailView);
                ...
                RowDetailViewExtension.prototype.renderPreloadView = function () {
                    ...
                    if (containerElement.length) {
                        ...
                        this._slotPreload = new aurelia_framework_1.ViewSlot(containerElement[0], true);
                ...
                RowDetailViewExtension.prototype.renderViewModel = function (item) {
                    ...
                    if (containerElement.length) {
                        ...
                        view.bind(viewModel, aurelia_framework_1.createOverrideContext(viewModel));
                        // Add the view to the slot
                        var viewSlot = new aurelia_framework_1.ViewSlot(containerElement[0], true);
                        viewSlot.add(view);
                ...
                RowDetailViewExtension = __decorate([
                    ...
                    aurelia_framework_1.inject(aurelia_framework_1.Container, aurelia_event_aggregator_1.EventAggregator, extensionUtility_1.ExtensionUtility, shared_service_1.SharedService, aurelia_framework_1.ViewCompiler, aurelia_framework_1.ViewResources)
                ], RowDetailViewExtension);
                return RowDetailViewExtension;
            }());
            exports_1("RowDetailViewExtension", RowDetailViewExtension);
        }
    };
});

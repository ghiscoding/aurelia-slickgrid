System.register(["aurelia-framework", "aurelia-i18n", "../constants", "../services/shared.service", "../models/index"], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ExtensionUtility = /** @class */ (function () {
            ...
            exports_1("ExtensionUtility", ExtensionUtility);
        }
    };
});

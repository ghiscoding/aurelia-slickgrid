...
[![Actions Status](https://github.com/slickgrid-stellar/aurelia-slickgrid/workflows/CI%20Build/badge.svg)](https://github.com/slickgrid-stellar/aurelia-slickgrid/actions)
[![Cypress.io](https://img.shields.io/badge/tested%20with-Cypress-04C38E.svg)](https://www.cypress.io/)
[![jest](https://jestjs.io/img/jest-badge.svg)](https://github.com/facebook/jest)
[![codecov](https://codecov.io/gh/slickgrid-stellar/aurelia-slickgrid/branch/master/graph/badge.svg)](https://codecov.io/gh/slickgrid-stellar/aurelia-slickgrid)
...
## Installation
Refer to the **[Wiki - HOWTO Step by Step](https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/HOWTO--Step-by-Step)** and/or clone the [Aurelia-Slickgrid Demos](https://github.com/slickgrid-stellar/aurelia-slickgrid-demos) repository. Please consult all Wikis before opening new issues, also consider asking installation and/or general questions on [Stack Overflow](https://stackoverflow.com/search?tab=newest&q=slickgrid) unless you think there's a bug with the library.
...
For a full compatibility table of Aurelia-Slickgrid with Slickgrid-Universal, you can consult the [Versions Compatibility Table - Wiki](https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Versions-Compatibility-Table)
...
- [Bootstrap 4 demo](https://slickgrid-stellar.github.io/aurelia-slickgrid-demos) / [examples repo](https://github.com/slickgrid-stellar/aurelia-slickgrid-demos/tree/master/webpack-bs4-demo)
- [Bootstrap 5 demo](https://slickgrid-stellar.github.io/aurelia-slickgrid) / [examples repo](https://github.com/slickgrid-stellar/aurelia-slickgrid-demos/tree/master/webpack-bs5-demo)

There are also 2 new Themes, Material & Salesforce that are available as well and if you wish to use SVG then take a look at the [Wiki - SVG Icons](https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/SVG--Icons).

#### Working Demos
For a complete working set of demos, you can clone the [Aurelia-Slickgrid Demos](https://github.com/slickgrid-stellar/aurelia-slickgrid-demos) repository (instructions are provided in the demo repo). This repo provides multiple samples (RequireJS, WebPack, CLI, ...) and it is also worth to know that the 2 WebPacks demos are updated frequently since they are the actual live GitHub [Bootstrap 4 demo](https://slickgrid-stellar.github.io/aurelia-slickgrid-demos/#/slickgrid) / [Bootstrap 5 demo](https://slickgrid-stellar.github.io/aurelia-slickgrid).

## Wiki / Documentation
The Wikis is where you'll find all the documentation and instructions for the lib, so please consult the [Aurelia-Slickgrid - Wiki](https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki) before opening any new issue. The [Wiki - HOWTO](https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/HOWTO--Step-by-Step) is a great place to start with.

### Latest News & Releases
Check out the [Releases](https://github.com/slickgrid-stellar/aurelia-slickgrid/releases) section for all latest News & Releases.
...
Fear not, you can simply reference the `SlickGrid` and `DataView` objects, just like in the core lib (they are exposed through Custom Events). For more info continue reading on [Wiki - SlickGrid & DataView objects](/slickgrid-stellar/aurelia-slickgrid/wiki/SlickGrid-&-DataView-Objects) and [Wiki - Grid & DataView Events](https://github.com/slickgrid-stellar/aurelia-slickgrid/wiki/Grid-&-DataView-Events)

...
Aurelia-Slickgrid reached **100%** Test Coverage, we are talking about +10,000 lines of code (+3,000 unit tests, now mostly in Slickgrid-Universal) that are now fully tested with [Jest](https://jestjs.io/). There are also over +400 Cypress E2E tests to cover most UI functionalities on nearly all Examples of Aurelia-Slickgrid.
